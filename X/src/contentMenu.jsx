...
function createFeed() {
  ...
  if (body.contains(newdiv)) {
    ...
    let buttons = [
        { text: "Add Topics", id: "addTopicsButton" },
        { text: "Add People", id: "addPeopleButton" },
        { text: "Add Communities", id: "addCommunitiesButton" }
      ];
