    ...
    return (
        <div className="leftbar" ref={leftBarRef}>
            <ul>
                ...
                <li onClick={()=>servicesPage()}>{services || service ?<Link to={'/services'} className='link'><img src={menu2} alt="menu_icon" className='menuIcon' /><h2>Services</h2></Link>:<Link to={'/services'} className='link'><img src={menu} alt="menu_icon" className='menuIcon' /><p>Services</p></Link>}</li>
