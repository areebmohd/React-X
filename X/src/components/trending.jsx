      ...
      <div className="posts">
        ...
        {trprofilePictures.map((picture, index) => (
          <div className="post" key={index}>
            ...
            <div className="content" dangerouslySetInnerHTML={{ __html: trcontent[index] }}></div>
            <img src={trpics[index]} alt="" className="contentPic" />
            <div className="icons">
              ...
              <div className="like icon">
                ...
                <p>{valueConverter(Math.floor(Math.random() * 100000))}</p>
              </div>
