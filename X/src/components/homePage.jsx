    ...
    <div className='homePage'>
      <div className='topBar'>
        ...
        <svg
          ...
          viewBox='0 0 448 512'
          height='25px'
          onClick={() => setContentMenu(prev => !prev)}
        >
      ...
      <div className='posts'>
        <div class='topics'>
          <h3 class='topic'>Following</h3>
          <h3 class='topic'>Subscribed</h3>
          <h3 class='topic'>Favorite</h3>
          <h3 class='topic'>Trending</h3>
          <h3 class='topic'>Originals</h3>
          <h3 class='topic'>Vines</h3>
          <h3 class='topic'>Videos</h3>
          <h3 class='topic'>Live</h3>
          <h3 class='topic'>Articles</h3>
        </div>
                      ...
                      <svg
                        ...
                        onClick={() => {
                          if (videoRef.current) {
                            ...
                            videoRef.current.nextElementSibling.style.display =
                              'none'
                          }
                        }}
                      >
