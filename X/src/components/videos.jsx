...
function Videos({ setContentMenu }) {
  ...
  const handlePlay = (index) => {
    if (currentVideo !== null && currentVideo !== videoRefs.current[index]) {
      currentVideo.pause();
      currentVideo.controls = false;
      currentVideo.nextElementSibling.style.display = 'block';
    }
      ...
      <div className="posts">
        ...
        {vprofilePictures.map((picture, index) => (
          <div className="post" key={index}>
            ...
            <div className="content" dangerouslySetInnerHTML={{ __html: vcontent[index] }}></div>
            <div className="videoWrapper">
              <video className="contentPic" ref={el => videoRefs.current[index] = el}>
                <source src={vpics[index]} type="video/mp4" />
