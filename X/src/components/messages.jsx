...
import { messagesPictures, messagesNames, messagesUsernames, messagesMessage } from '../../data';

function Messages() {

    const { setHomePage, setMessages, setChatBoxPage, setChatPic, setChatName, setProfile, setExplorePage, setMessage, toggleLeftBar } = useAppContext();
    ...
    const handleClick = (index) => {
        setChatBoxPage(true);
        setChatPic(messagesPictures[index]);
        setChatName(messagesNames[index]);
        setMessage(messagesMessage[index]);
      };
