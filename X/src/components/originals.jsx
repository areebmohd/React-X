            ...
            <div className="posts">
                ...
                {ogProfilePictures.map((picture, index) => (
                    <div className="post" key={index}>
                        ...
                        <div className="content" dangerouslySetInnerHTML={{ __html: ogContent[index] }}></div>
                        {ogPics[index] && (
                            <div className="media">
