...
import { postsContent, postsPics } from '../../data';
      ...
      {postsPics.map((picture, index) => {
        ...
        return (
          <div className="post" key={index}>
            ...
            <div className="content" dangerouslySetInnerHTML={{ __html: postsContent[index] }}></div>
            {picture && (
              <div className="media">
                {picture.endsWith('.mp4') ? (
                  ...
                  <img className="contentPic" src={picture} alt="content" />
                )}
              </div>
            )}
            <div className="icons">
